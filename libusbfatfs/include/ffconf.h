...
// The program is compatible with single partition. If you want to enable multiple partition,
// then there will be changes required in the diskio.c for multiple partition. 
// For more info read the comments below the macro. In addition you can refer to FATfs website for help.
